...
data Env = Env
    ...
    , envVertexShader     :: !GL.VertexShader
    , envFragmentShader   :: !GL.FragmentShader
    , envProjectionMatxU  :: !GL.UniformLocation
    , envModelMatxU       :: !GL.UniformLocation
    , envViewMatxU        :: !GL.UniformLocation
    , envVaoId            :: !GL
    }
